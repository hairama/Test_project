...
DATATYPE_LOCATIONS.append('Test_project.datatypes')
FUNCTION_LOCATIONS.append('Test_project.functions')
ETL_MODULE_LOCATIONS.append('Test_project.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('Test_project.search_components')
...
SECRET_KEY = '#n@ubrc53byl2m!uy7c_0=4xb5=ew9vu_-f7p_3(*$ic4r+((5'
...
ELASTICSEARCH_PREFIX = 'Test_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'Test_project.search_indexes.sample_index.SampleIndex',
...
SESSION_COOKIE_NAME = 'Test_project'
